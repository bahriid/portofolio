            ...
            <div class="col-lg-4 box-img main-bg">
                <div class="cont valign">
                    <div class="full-width">
                        <div class="img">
                            <img src="porto/imgs/header/profile.jpg" alt="">
                            <span class="icon">
    ...
    <section class="in-box">
                                ...
                                <div class="d-flex align-items-center mb-30">
                                    <div class="mr-30">
                                        <div class="img icon-img-40">
                                            <img src="porto/imgs/resume/s1.png" alt="">
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div class="col-md-6">
                            <div class="item mb-30">
                                <div class="d-flex align-items-center mb-30">
                                    <div class="mr-30">
                                        <div class="img icon-img-40">
                                            <img src="porto/imgs/resume/s2.png" alt="">
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div class="col-md-6">
                            <div class="item sm-mb30">
                                <div class="d-flex align-items-center mb-30">
                                    <div class="mr-30">
                                        <div class="img icon-img-40">
                                            <img src="porto/imgs/resume/s3.png" alt="">
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div class="col-md-6">
                            <div class="item">
                                <div class="d-flex align-items-center mb-30">
                                    <div class="mr-30">
                                        <div class="img icon-img-40">
                                            <img src="porto/imgs/resume/s4.png" alt="">
                                        </div>
                                    </div>
                                    <div>
                ...
                <div class="row md-marg">
                    <div class="col-lg-4">
                        <div class="award-item sub-bg md-mb30 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="img icon-img-100 mt-80 mb-30">
                                <img src="porto/imgs/awards/1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="award-item sub-bg md-mb30 wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="img icon-img-100 mt-80 mb-30">
                                <img src="porto/imgs/awards/2.png" alt="">
                            </div>
                            <h6>02x Designer Award</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="award-item sub-bg wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="img icon-img-100 mt-80 mb-30">
                                <img src="porto/imgs/awards/3.png" alt="">
                            </div>
                            <h6>02x Designer Award</h6>
                ...
                <div class="row">
                        ...
                        <div class="item mt-50 wow fadeInUp" data-wow-delay=".2s">
                            <div class="img">
                                <a href="project-details.html">
                                    <img src="porto/imgs/works/1.jpg" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6 items">
                        <div class="item mt-50 wow fadeInUp" data-wow-delay=".4s">
                            <div class="img">
                                <a href="project-details.html">
                                    <img src="porto/imgs/works/2.jpg" alt="">
                                </a>
                            </div>
                            <div class="cont mt-30 d-flex align-items-center">
                                <div>
                    ...
                    <div class="col-lg-6 items">
                        <div class="item mt-50 wow fadeInUp" data-wow-delay=".6s">
                            <div class="img">
                                <a href="project-details.html">
                                    <img src="porto/imgs/works/3.jpg" alt="">
                                </a>
                            </div>
                            <div class="cont mt-30 d-flex align-items-center">
                                <div>
                    ...
                    <div class="col-lg-6 items">
                        <div class="item mt-50 wow fadeInUp" data-wow-delay=".8s">
                            <div class="img">
                                <a href="project-details.html">
                                    <img src="porto/imgs/works/4.jpg" alt="">
                                </a>
                            </div>
                            <div class="cont mt-30 d-flex align-items-center">
                                <div>
        ...
        <div class="sec-box testimonials section-padding">
            <div class="pad-left">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="testim-swiper wow fadeIn" data-carousel="swiper" data-item="1" data-space="30"
                             data-speed="1000">
                                        ...
                                        <div class="item d-flex">
                                            <div>
                                                <div class="icon-img-60 mr-60">
                                                    <img src="porto/imgs/svg-porto/quote.png" alt="">
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <div class="img">
                                                            <img src="porto/imgs/testim/1.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="ml-30">
                                                        <div class="info">
                                        ...
                                        <div class="item d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <div class="img">
                                                            <img src="porto/imgs/testim/2.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="ml-30">
                                                        <div class="info">
                                        ...
                                        <div class="item d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <div class="img">
                                                            <img src="porto/imgs/testim/3.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="ml-30">
                                                        <div class="info">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="item md-mb30 wow fadeIn" data-wow-delay=".2s">
                        <div class="img">
                            <img src="porto/imgs/blog/1.jpg" alt="">
                        </div>
                        <div class="box">
                            <div class="cont">
                ...
                <div class="col-lg-4">
                    <div class="item md-mb30 wow fadeIn" data-wow-delay=".4s">
                        <div class="img">
                            <img src="porto/imgs/blog/2.jpg" alt="">
                        </div>
                        <div class="box">
                            <div class="cont">
                                    <span class="date"><i class="fas fa-calendar-alt mr-10 main-color"></i> 6 , Aug
                ...
                <div class="col-lg-4">
                    <div class="item wow fadeIn" data-wow-delay=".6s">
                        <div class="img">
                            <img src="porto/imgs/blog/3.jpg" alt="">
                        </div>
                        <div class="box">
                            <div class="cont">
                                    <span class="date"><i class="fas fa-calendar-alt mr-10 main-color"></i> 6 , Aug
...
<!-- Mirrored from ui-themez.smartinnovates.net/items/Gavi/dark/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Apr 2025 14:07:34 GMT -->
</html>
